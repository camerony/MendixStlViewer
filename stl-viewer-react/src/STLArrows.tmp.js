...
export default function Stl(stlid, width, height, file, objectColor, primaryColor,volume) {
    ...
    scene.add(grid);
    // const rotationBtn = document.getElementById("rotate"+stlid);
    // rotationBtn.addEventListener("click", () => {
    //     console.log(rotateModel);
    //     rotateModel = !rotateModel;
    //     controls.autoRotate = rotateModel;
    // });
    // const gridBtn = document.getElementById("grid"+stlid);
    ...
    const dim0 = new RayysLinearDimension(document.getElementById("stlviewer"+stlid), renderer, camera);
    const dim1 = new RayysLinearDimension(document.getElementById("stlviewer"+stlid), renderer, camera);
